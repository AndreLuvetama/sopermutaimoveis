                ...
                <main>                  
                        <div class="card mb-4">
                            <div class="card-header">
                              <div class="row">
                                <div class="col-sm-7 pt-2"><i class="fas fa-table mr-1"></i><?php echo"$getQtdeUsuario";?> usuários cadastrados</div> <div class="col-sm-5 float-sm-right "> 
                                ...
                                <div class="table-responsive">
                                    <table class="table"  id="minhaTabela" width="100%" cellspacing="0">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th class="text-center font-weight-bold">Cod usuário</th>
                                                <th class="text-center font-weight-bold">Nome completo</th>
                                                <th class="text-center font-weight-bold">Nome do usuário</th>
                                                ...
                                                <th class="text-center font-weight-bold">Data incl</th>
                                                 <th class="text-center font-weight-bold">Tipo usuário</th>
                                        ...
                                        <tbody>
                                        <?php  if(!empty($usuarioPorPag))
                                          { $i=0;
                                            foreach($usuarioPorPag as $usuario){ $i++; ?>                                      
                                            <tr>
                                               ...
                                               <td><?php echo $usuario['cidade']; ?></td>
                                                <td><?php echo $usuario['dataIncl']; ?></td>
                                                <td><?php if($usuario['tipo_usuario_id'] == 1){
                                                    echo "Permutando";
                                                }
                                                else{
                                                ...
                                                <td><?php if($usuario['statusAssinante'] == 0){
                                                    ...
                                                    echo "<span class='text-info'>Assinante</span>";
                                                }

                                                ?></td>
                                                <td><div class="col">
                                                 <div class="row"> <a href="<?php echo base_url('admin/editarUsuario/'.$usuario['usuario_id']); ?>" class="btn btn-primary"><i class="far fa-eye"></i></a></div>                                               
                                                </div></td>

                                                  <td><div class="col">
                                                    <div class="row">
                                                      <a href="<?php echo base_url('admin/excluirUser/'.$usuario['usuario_id']); ?>" class="btn btn-danger">
