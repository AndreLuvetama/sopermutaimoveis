  ...
  <body>
   ...
   <section id ="home">
    <div class="container">
        <div class = "row testo pt-5">
             <div class="col-sm-6">
                <font style= "color: #3589A1"><h2> Entenda o processo de Permuta</h2></font></br>
   ...
   <section id="caixa1">
    <div class="container">
        <div class="row testo pt-5">
          <div class="col-sm-8">
            <font style= "color: #3589A1"><h2> Como faço para interagir com o imóvel do meu interece</h2></font></br>
          ...
          <div class="col-sm-4">
           <font style= "color: #3589A1"><h3>Posso propor uma venda?</h3></font></br>
            <span class="testo_formatado">
              Segundo as propostas apresentadas a Verdade já foi Deus, tornou-se a razão humana -
              que é resultado da evolução do intelecto,  depois o próprio homem, agora já não há verdade
              nenhuma ou é o conjunto de todas as nossas verdades idealizadas. Isto porque a verdade
          ...
          <div class="col-sm-12">
            <font style= "color: #3589A1"><h3>Posso desistir depois do contrato</h3></font></br>
            <span class="testo_formatado">
              Segundo as propostas apresentadas a Verdade já foi Deus, tornou-se a razão humana -
              que é resultado da evolução do intelecto,  depois o próprio homem, agora já não há verdade
              nenhuma ou é o conjunto de todas as nossas verdades idealizadas. Isto porque a verdade
          ...
          <div class= "col-sm-12 img-comofunciona">
